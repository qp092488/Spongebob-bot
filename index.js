...
client.on('message', (message) => {
  ...
  if(message.content == '<si') {
    ...
    let img = 'https://cdn.discordapp.com/attachments/743671938861367319/753091363226255421/ddd.jpg';
    var duration = moment.duration(client.uptime).format(" D [일], H [시간], m [분], s [초]");
    embed.setColor('#186de6')
    embed.setAuthor('server info of 스펀지밥', img)
  ...
  if(message.content == '<프로필') {
    ...
    let helpImg = 'https://cdn.discordapp.com/attachments/743671938861367319/753091363226255421/ddd.jpg';
    let commandList = [
      {name: '<명령어', desc: '도움말'},
